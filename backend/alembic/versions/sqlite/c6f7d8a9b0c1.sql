...
INSERT INTO _alembic_tmp_procedure_steps (id, procedure_id, "key", title, prompt, metadata, position) SELECT procedure_steps.id, procedure_steps.procedure_id, procedure_steps."key", procedure_steps.title, procedure_steps.prompt, procedure_steps.metadata, procedure_steps.position 
